var ROOTDM = [".dayoo.com"];
var INCLUDESUBHOST = ["www.dayoo.com"];
var SHOWERRHOST=1;
var _wdUID="1";
var _wecl="//stats.dayoo.com/1.js";
...
function wdGenCID() {
	var urlhash = wdHash(document.location + document.cookie + document.referrer + curtime.getTime()).toString(16);

	var iradom = parseInt(10000*random());

	return urlhash + "." + (curtime.getTime()+iradom).toString(16);
}
...
function wd_tracker(otherlink){
	...
	if (otherlink && otherlink!="") {
		var tmp = _wdSL;
		if(otherlink.toLowerCase().indexOf('http') ==-1 )
