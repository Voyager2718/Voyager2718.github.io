...
function showTitlePane(state,txt,iLeft,iTop) 
{
		...
		if (loadingPane == null) {
			...
			el.style.cssText="background-color:#ea5f02; padding:15px; display:none;font-family:宋体;font-size:16px;color:#FFFFFF;font-weight:bold; border:2px solid #FF6666;position:absolute; right:1px; top:1px; bottom:1px; left:1px;width:30%; height:12%; z-index:10000;filter:alpha(opacity=90);";
