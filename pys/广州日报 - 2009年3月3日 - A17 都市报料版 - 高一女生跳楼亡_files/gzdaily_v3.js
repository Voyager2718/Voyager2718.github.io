...
function drawCalendar (id, y, m, selectedDate) {
	...
	var calendarHtml = '<!-- year and month --><p class="title"><span class="year"><a href="###" onclick="drawCalendar(\''+id+'\', \''+(cal.getFullYear()-1)+'\', \''+cal.getMonth()+'\', null);"><img src="http://gzdaily.dayoo.com/tpl/blank.gif" alt="up" class="up" /></a>'+cal.getFullYear()+'年<a href="###" onclick="drawCalendar(\''+id+'\', \''+(cal.getFullYear()+1)+'\', \''+cal.getMonth()+'\', null);"><img src="http://gzdaily.dayoo.com/tpl/blank.gif" alt="next" class="next" /></a></span><span class="month"><a href="###" onclick="drawCalendar(\''+id+'\', \''+cal.getFullYear()+'\', \''+(cal.getMonth()-1)+'\', null);"><img src="http://gzdaily.dayoo.com/tpl/blank.gif" alt="up" class="up"/></a>'+(cal.getMonth()+1)+'月<a href="###" onclick="drawCalendar(\''+id+'\', \''+cal.getFullYear()+'\', \''+(cal.getMonth()+1)+'\', null);"><img src="http://gzdaily.dayoo.com/tpl/blank.gif" alt="next" class="next" /></a></span></p><!-- year and month Endding --><div class="date"><p class="week"><span>日</span><span>一</span><span>二</span><span>三</span><span>四</span><span>五</span><span>六</span></p><ul>';
	while (1) {
